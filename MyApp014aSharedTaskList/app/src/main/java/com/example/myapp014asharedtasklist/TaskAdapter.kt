...
class TaskAdapter(
    ...
    override fun onBindViewHolder(holder: TaskViewHolder, position: Int) {
        ...
        with(holder.binding) {
            ...
            // Aby se listener nevyvolal při nastavování hodnoty
            ...
            // Správný listener – aktivuje se pouze po skutečném kliknutí
            checkCompleted.setOnCheckedChangeListener { _, _ ->
                onChecked(task)
            }
